...
export default async function Cart() {
    ...
    return (
        <div className="relative overflow-x-auto sm:rounded-lg">
            <h1 className='mb-6 text-4xl font-black text-gray-900 dark:text-white'>My Shopping Cart</h1>
                ...
                <tfoot>
                    <tr className='odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700'>
                        ...
                        <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white" colSpan={4}>
                            {data.cartItems.map((cartItem:any, index:number) => (cartItem.product.price*cartItem.qty)).reduce((a:number, b:number) => a + b, 0).toFixed(2)+ ' €'}
                        </td>
                    </tr>
