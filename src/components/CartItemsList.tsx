...
import { CartItemsContext } from '@/providers/cartItemProvider'
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex items-center">                         
                                                <div className="inline-flex rounded-md shadow-sm " role="group" >
                                                    ...
                                                    <button type="button" className="inline-flex items-center px-3 py-2 text-gray-900 bg-gray-200 dark:bg-black border border-gray-900 rounded-e-lg hover:bg-gray-900 hover:text-white dark:border-white dark:text-white dark:hover:text-white dark:hover:bg-gray-900">
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
